				...
				<div class="row">
					<div class="col-md-offset-4 col-md-4 col-md-offset-4">
						<form id="product" name="product" accept-charset="UTF-8" action="./new_product" method="post">
							...
							<div>
								<div style="padding-bottom:10px;">이름</div> <div> <input id="name" name="name" class="form-control" type="text" value=""/>
								</div>
							</div>
							<div>
								<div style="padding:20px 0 10px 0;">재고</div><div><input id="number" name="number" class="form-control" type="number" value="0"/></div>
							</div>
							<div>
								<div style="padding:20px 0 10px 0;">설명</div><div><input id="desc" name="desc" class="form-control" type="text" value=""/></div>
							</div>
