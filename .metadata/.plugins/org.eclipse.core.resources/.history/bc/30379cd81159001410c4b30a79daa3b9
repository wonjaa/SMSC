				...
				<nav id="nav">
					<ul>
						...
						<ul class="" style="-webkit-user-select: none; display: none; position: absolute;">
								<li style="white-space: nowrap;"><a href="#" style="display: block;">Generic</a></li>
								<li style="white-space: nowrap;"><a href="#" style="display: block;">Contact</a></li>
								<li style="white-space: nowrap;"><a href="#l" style="display: block;">Elements</a></li>
								<li class="opener" style="-webkit-user-select: none; cursor: pointer; white-space: nowrap;">
						...
						<li style="white-space: nowrap;"><a href="#" class="button" style="color:#000;">Sign Up</a></li>
					</ul>
				</nav>
			</header>