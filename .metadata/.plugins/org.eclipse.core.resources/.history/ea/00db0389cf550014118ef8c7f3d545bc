...
<body>
	...
	<div class="container small">
		...
		<div>
			<div>
				<form id="product" name="product" accept-charset="UTF-8" action="/3211offon/productlist/1" method="post">
					...
					<div>
						...
						<div>
							<input id="name" name="name" class="form-control" type="text" th:value="${product.name}"/>
					...
					<div>
						...
						<div>
							<input id="number" name="number" class="form-control" type="number" th:value="${product.number}"/>
					...
					<div>
						...
						<div>
							<input id="desc" name="desc" class="form-control" type="text" th:value="${product.desc}"/>
