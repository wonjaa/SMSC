...
public class HomeController {
	...
	public String home_post(@ModelAttribute User user, Model model,
			HttpSession session) {
	...
	public String product_modify(
			@PathVariable("product_no") Integer product_no, Model model,
			HttpSession session) {
	...
	public String product_m_complete(
	...
	public String new_product(@ModelAttribute("product") Product product,
	...
	public String new_product_com(@ModelAttribute("product") Product product,
			Model model, HttpSession session) {
	...
	public String delete(@PathVariable("product_no") Integer product_no,
			Model model, HttpSession session) {
	...
	public String register_complete(@ModelAttribute("user") User user,
